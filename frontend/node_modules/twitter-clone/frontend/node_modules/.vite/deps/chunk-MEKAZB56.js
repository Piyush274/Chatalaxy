...
// node_modules/@react-three/fiber/dist/index-6662eaf2.esm.js
...
function loadingFn(extensions, onProgress) {
  return function(Proto, ...input) {
    ...
    return Promise.all(input.map((input2) => new Promise((res, reject) => loader.load(input2, (data) => {
      ...
      res(data);
    }, onProgress, (error2) => reject(new Error(`Could not load ${input2}: ${error2.message}`)))))).finally(() => loader.dispose == null ? void 0 : loader.dispose());
  };
}
...
scheduler/cjs/scheduler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MEKAZB56.js.map
